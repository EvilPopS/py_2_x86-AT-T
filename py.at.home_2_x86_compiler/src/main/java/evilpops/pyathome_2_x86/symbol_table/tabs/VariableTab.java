...
public class VariableTab extends ScopeTableArchetype<VariableTabRow> {
    public void add(int mainTabFK, DataType dataType, int scope, String name, int ordinality) {
        this.table.add(new VariableTabRow(mainTabFK, dataType, scope, name, ordinality));
    }
